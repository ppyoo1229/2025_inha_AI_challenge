...
class Config:
    def __init__(self):
        ...
        self.MAX_TRAIN_STEPS = 1200 # 총 학습 스텝 수 (None이면 EPOCHS로 계산)
        self.RESUME_FROM_CHECKPOINT = "" # "./output5/checkpoint-40"
        self.SAMPLE_SAVE_START_STEP = 120 # 샘플 이미지 저장 시작 스텝
        self.SAMPLE_SAVE_END_STEP = 1200 # 샘플 이미지 저장 종료 스텝

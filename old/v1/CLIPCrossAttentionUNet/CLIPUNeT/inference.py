...
PROJECT_DIR = os.path.join(BASE_DIR, 'CLIPUNET')    
DATA_DIR = BASE_DIR
...
from train import ColorizationDataset, CLIP_CrossAttn_UNet

# 데이터 로딩
test_df = pd.read_csv(TEST_CSV)
test_set = ColorizationDataset(test_df, input_dir=TEST_IMG_DIR, gt_dir=None, is_test=True)
